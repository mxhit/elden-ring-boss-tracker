...
export function getBossPerLocation(location) {
    let bossListBody = [];

    bosses.filter(boss => boss.location === location)
        .map(boss => {
            bossListBody.push(new Boss(boss.id, boss.name, boss.description, false));
